...
class CreateRoomView(APIView):
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            # this is to create a new session or room
    ...
    def post(self, request, format=None):
        ...
        if code is not None:
            ...
            if room_result.exists():
                ...
                return Response({'message': 'Rooom Joined!'}, status=status.HTTP_200_OK)
...
class GetRoom(APIView):
    ...
    def get(self, request):
        # this make a lookup in the url to see if the code exists
